...
## 2024-06-03 - Prevent Argument Injection in plugin_remove_command
**Vulnerability:** Argument injection when uninstalling plugins via CLI.
**Learning:** `subprocess.run` with untrusted input at the end of the argument list can lead to argument injection if the input starts with `-` or `--`.
